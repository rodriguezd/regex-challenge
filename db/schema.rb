...
ActiveRecord::Schema.define(:version => 20130826203758) do
  ...
  create_table "in_strings", :force => true do |t|
    t.text     "string"
    t.datetime "created_at", :null => false
    t.datetime "updated_at", :null => false
  end

  create_table "input_output_strings", :force => true do |t|
  ...
  create_table "input_strings", :force => true do |t|
    t.text     "string"
    t.integer  "output_string_id"
    t.datetime "created_at",       :null => false
    t.datetime "updated_at",       :null => false
  ...
  create_table "regex_challenge_user_times", :force => true do |t|
